  ...
  return (
    <MainWrapper>
      <BannerContainer>
        ...
        <BannerText>
          <br />
          <a>이론이 아닌 현실에 발 붙이고 서서 할 수 있는 작은 실천</a>
        </BannerText>
        <TextRow>
      ...
      <CampaignContainer>
        <TextSection>
          ...
          <ContentsTextBox2>
            ...
            캠코더 프로젝트는 생활반경 안에서
            <p />
            누구나 실천가능 환경보호를 제안합니다. <br />
            <br />
            <p />
            환경보호에 대한 진입장벽을 낮추고
            <p />
            Plastic Free 문화를 MZ세대로 확신하기 위한
            <p />
            <ContentsTextBox3>캠퍼스 기반 리필스테이션 !</ContentsTextBox3>
            <p />
          </ContentsTextBox2>
      ...
      <ContainerBack>
        <Container>
          ...
          <OrgChart>
            <MainBranch>
              <CampaignImage src={mnm} alt="Our Campaign" />
            </MainBranch>
            <LineContainer>
            ...
            <BranchesContainer>
              <Branch>
                <CampaignImage2 src={swwu} alt="Our Campaign" />
              </Branch>
              <Branch>
                <CampaignImage2 src={sj} alt="Our Campaign" />
              </Branch>
            </BranchesContainer>
          </OrgChart>

          <FooterText>
            각 대학별 운영진은 먼저 본교 내에서 학생들이 가장 많이 오가는
            &#39;핵심 장소&#39;를 선정합니다.
            <br />
            그곳에 저희의 고체 세계 가치를 설치하고, 학생들이 편리하게 이용할 수
            있도록 관리합니다.
            <br />
            운영진은 세계 공급 상태와 기계의 유지 보수를 철저히 관리하고, 본사는
            이 진행 상황을 체계적으로 체크하면서 일괄한 운영을 지원합니다.
          </FooterText>
        </Container>
      </ContainerBack>
      ...
      <CampaignContainer>
        <TextSection2>
          ...
          <CampaignText>
            2024 동덕여자대학교 대동제에서 우리는 특별한 환경 캠페인을
            펼쳤습니다! 동덕여대 환경지키기 x 리필스테이션 &#39;청산유수&#39; x
            SK LOOKIE MMN 3대 연합이 힘을 모아, 캠퍼스에 새로운 바람을
            불러일으켰습니다.
            <br />
            <br />
            축제 참가자들은 환경 인식을 높이기 위한 특별 부스를 운영했는데요.
            특히 이번에는 5세 이상의 어린이를 초대해 환경 인식을 높이기 위한
            환경교육을 진행하는 뜻깊은 시간을 가졌습니다.
            <br />
            <br />
            아이들이 자연스럽게 환경의 중요성을 배우고, 작은 실천으로도 큰
            변화를 만들 수 있다는 메시지를 전달했습니다.
            <br />
            <br />이 경험이 어린이들에게 환경을 생각하는 첫걸음이 되길 바라며,
            대학생들과 지역사회가 함께하는 더욱 의미 있는 캠페인으로 발전해
            나가고자 합니다!
          </CampaignText>
        </TextSection2>
        <ImageSection2>
      ...
      <InstagramContainer>
        ...
        <ProfileSection>
          ...
          <br />
          <ProfileName href="https://instagram.com/mnm_ddsl">
            @mnm_ddsl
          </ProfileName>
          <br />
        </ProfileSection>
